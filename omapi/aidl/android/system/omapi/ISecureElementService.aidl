...
interface ISecureElementService {
     ...
     *
     * ## Error conditions
     * `SecureElementErrorCode::AID_OUT_OF_RANGE` if aid array length is not according
     *                            to the ISO 7816-5.
     * `SecureElementErrorCode::PACKAGE_NAMES_NOT_SPECIFIED` if the package names are
     *                            missing.
     *
     * @param reader       The name of the reader.
