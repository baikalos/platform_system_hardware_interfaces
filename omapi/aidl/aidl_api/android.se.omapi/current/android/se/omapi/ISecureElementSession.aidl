...
interface ISecureElementSession {
     ...
     */
    android.se.omapi.ISecureElementChannel openBasicChannel(in byte[] aid, in byte p2,
            in android.se.omapi.ISecureElementListener listener);
     ...
     */
    android.se.omapi.ISecureElementChannel openLogicalChannel(in byte[] aid, in byte p2,
            in android.se.omapi.ISecureElementListener listener);
}
