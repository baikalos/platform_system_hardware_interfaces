 ...
 * @activeSince:    Time the wake lock was last activated.
 * @activeCount:    Number of times the wake lock was activated.
 * @maxTime:        Maximum time this wake lock has been continuously active.
 * @totalTime:      Total time this wake lock has been active.
