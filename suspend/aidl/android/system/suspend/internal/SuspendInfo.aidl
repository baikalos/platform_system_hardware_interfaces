...
parcelable SuspendInfo {
    ...
    /**
     * Total number of times that a short suspend occurred. A suspend is considered a short suspend
     * if the suspend duration is less than suspend.short_suspend_threshold_millis
     */
    ...
    long failedSuspendOverheadTime;
    ...
    /**
     * Total time, in milliseconds, that system has waited between repeated suspend attempts
     * when the wait interval is above the baseline configured suspend.base_sleep_time_millis
     */
