...
int main() {
    ...
    SleepTimeConfig sleepTimeConfig = {
        ...
        .suspendBackoffThreshold = SuspendProperties::suspend_backoff_threshold().value_or(
            kDefaultSuspendBackoffThreshold),
    ...
    sp<SystemSuspend> suspend = new SystemSuspend(
        ...
        std::move(suspendTimeFd), sleepTimeConfig, suspendControl, true /* mUseSuspendCounter*/);
