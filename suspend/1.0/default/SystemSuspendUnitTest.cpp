...
TEST_F(SystemSuspendTest, WakeLockStatsRaceConditionTest) {
    ...
    for (int i = 0; i < kNumRetries; i++) {
        ...
        EXPECT_GE(wlInfo.activeTime, 10);  // WakeLock should have been active for atleast 10ms.
...
// Tests for correctness of the wakelock active count when multiple wakelocks of the same name
// are acquired sequentially and released sequentially.
