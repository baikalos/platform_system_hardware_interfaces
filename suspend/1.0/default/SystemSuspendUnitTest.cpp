...
TEST_F(WakeupTest, TestServiceSimple) {
    wakeup("abc");
...
TEST_F(WakeupTest, TestServiceChained) {
    wakeup("a\nb");
...
TEST_F(WakeupTest, TestServiceComplex) {
    wakeup("abc");
    wakeup("d\ne");
    wakeup("");
    wakeup("");
...
TEST_F(WakeupTest, TestNoCapacity) {
...
TEST_F(WakeupTest, TestNewEntry) {
    WakeupList wakeupList(3);
...
TEST_F(WakeupTest, TestIncrement) {
    WakeupList wakeupList(3);
...
TEST_F(WakeupTest, TestCapacity) {
    WakeupList wakeupList(3);
...
TEST_F(WakeupTest, TestLRUEvict) {
    WakeupList wakeupList(3);
