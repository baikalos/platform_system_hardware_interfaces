...
parcelable AudioHalCapRule {
  android.media.audio.common.AudioHalCapRule.Operand[] operands;
  @VintfStability
  enum CompoundRule {
    ANY = 0,
    ALL,
  ...
  union Operand {
    ...
    android.media.audio.common.AudioHalCapRule.CriterionRule criterionRule;
    android.media.audio.common.AudioHalCapRule.Delimiter delimiter = android.media.audio.common.AudioHalCapRule.Delimiter.END;
  }
}
