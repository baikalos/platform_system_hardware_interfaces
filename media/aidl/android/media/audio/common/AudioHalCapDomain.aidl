...
parcelable AudioHalCapDomain {
     ...
     * the value of the parameters controlled by this domain.
     */
    AudioHalCapConfiguration[] configurations;
    /**
     * A non-empty list of settings, aka the values of the parameters associated to the listed
     * configuration within this domain. All the settings within a domain shall define values for
     * the same parameters belonging to this domain.
     */
