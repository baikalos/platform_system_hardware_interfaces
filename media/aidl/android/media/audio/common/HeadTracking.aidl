...
parcelable HeadTracking {
     ...
     * The only Headtracking data format framework pass to HAL Spatializer  is head-to-stage for
     * now. In case we need other data format in further, the union tag can be used to identify the
     * data format.
     */
    union SensorData {
        /**
