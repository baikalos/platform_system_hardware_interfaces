...
interface IKeystoreSecurityLevel {
  ...
  android.system.keystore2.KeyMetadata generateKey(in android.system.keystore2.KeyDescriptor key, in android.system.keystore2.KeyParameter[] params, in byte[] entropy);
  android.system.keystore2.KeyMetadata importKey(in android.system.keystore2.KeyDescriptor key, in android.system.keystore2.KeyParameter[] params, in byte[] keyData);
