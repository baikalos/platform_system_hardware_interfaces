...
enum ResponseCode {
     ...
     * available. The framework portion of Keystore should poke the RemoteProvisioner app's binder
     * interface upon receiving this in order to wake it up and tell it to provision more keys.
     */
    OUT_OF_KEYS = 22,
}
